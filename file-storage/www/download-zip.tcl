...
if {$status=="chekd_out"} {
	db_dml update_state "update cr_items set publish_status ='$status', status_updated_by=$user_id where item_id=$object_id"
...
#if {$status=="chekd_out"} { 
#ad_returnredirect "/file-storage/index?folder_id=$object_id"
#}
