...
##lappend actions "$rename_name" file-edit?[export_vars file_id] "Rename file" \
...
#}
 ...
 #vijetha@vmc 01/04/2013 deletd below  line from below template. So that we cant display any action list
#    -actions $actions \
