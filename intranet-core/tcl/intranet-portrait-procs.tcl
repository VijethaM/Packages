...
ad_proc im_portrait_html_helper { 
   ...
   # ------------ Check if there is a portrait in the FS --------
    ...
    if {"" != $portrait_file} {
	set portrait_gif "<img  src=\"$user_fs_url/$portrait_file\" alt=\"$portrait_alt\" title=\"$portrait_alt\"  width=\"100\" height=\"150\">"
    }
	...
	if {$portrait_p} {
	    ...
	    # set portrait_gif "<img $widthheight src=\"/shared/portrait-bits.tcl?user_id=$user_id\" alt=\"$portrait_alt\" title=\"$portrait_alt\" >"
         set portrait_gif "<img  src=\"/shared/portrait-bits.tcl?user_id=$user_id\" alt=\"$portrait_alt\" title=\"$portrait_alt\" width=\"100\" height=\"150\">"
	} 
    }
