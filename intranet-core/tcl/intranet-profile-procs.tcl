...
ad_proc -public im_profile_employees {} { 
     return [im_profile::profile_id_from_name -profile "Associate"]
}

ad_proc -public im_profile_project_managers {} { 
     return [im_profile::profile_id_from_name -profile "Head&Partners"]
}

ad_proc -public im_profile_senior_managers {} { 
     return [im_profile::profile_id_from_name -profile "Cxo"] 
}
...
ad_proc -public im_profile_freelancers {} { 
     return [im_profile::profile_id_from_name -profile "User Admins"] 
}
...
ad_proc -public im_profile_sales {} { 
     return [im_profile::profile_id_from_name -profile "Web Content Admin"] 
}
...
ad_proc -public im_profile_helpdesk {} { 
     return [im_profile::profile_id_from_name -profile "Account Management"] 
}
...
ad_proc -public im_profile_cxos {} { 
     return [im_profile::profile_id_from_name -profile "Cxo"] 
}
