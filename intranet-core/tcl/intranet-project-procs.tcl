...
ad_proc -public im_task_questions_component {
	project_id
} {
	returns list of brands for that company
	@author vijetha.m@venkatmangudi.company_path
	@date 2013-Jan-29
} {

	set params ""
   	set result [ad_parse_template -params $params "/packages/intranet-core/www/admin/project_questions"]
   	return $result
}
