...
set cxo_gp_id [db_string x "select group_id from groups where group_name='Cxo'" -default 0]
set is_cxo [db_string dd "select group_id from group_element_index where element_id = $user_id and group_id=$cxo_gp_id" -default 0]
...
if {"t" == $mine_p && $admin_p!=1 && $is_cxo==0 } {
    set perm_sql "
	(select	p.*
	from	im_projects p,
		acs_rels r
