...
ad_proc -public im_date_to_comp_date {
    {-date ""}
} {
changes the date format for compairision
} {


set date_day [lindex [split $date "-"] 0]
set date_month_ch [lindex [split $date "-"] 1]
set date_year [lindex [split $date "-"] 2]
if {$date_month_ch=="Jan"||$date_month_ch=="jan"} {set date_month "01"} elseif {$date_month_ch=="Feb"||$date_month_ch=="feb"} {set date_month "02"} elseif {$date_month_ch=="Mar"||$date_month_ch=="mar"} {set date_month "03"} elseif {$date_month_ch=="Apr"||$date_month_ch=="apr"} {set date_month "04"} elseif {$date_month_ch=="May"||$date_month_ch=="may"} {set date_month "05"} elseif {$date_month_ch=="Jun"||$date_month_ch=="jun"} {set date_month "06"} elseif {$date_month_ch=="Jul"||$date_month_ch=="jul"} {set date_month "07"} elseif {$date_month_ch=="Aug"||$date_month_ch=="aug"} {set date_month "08"} elseif {$date_month_ch=="Sep"||$date_month_ch=="sep"} {set date_month "09"} elseif {$date_month_ch=="Oct"||$date_month_ch=="oct"} {set date_month "10"} elseif {$date_month_ch=="Nov"||$date_month_ch=="nov"} {set date_month "11"} elseif {$date_month_ch=="Dec"||$date_month_ch=="dec"} {set date_month "12"}
set date_cmpr "$date_year-$date_month_ch-$date_day"
return $date_cmpr
}