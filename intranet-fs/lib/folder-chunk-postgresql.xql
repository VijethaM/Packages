   ...
   <rdbms><type>postgresql</type><version>7.1</version></rdbms>
    <fullquery name="select_folder_contents">
        <querytext>
            ...
            select distinct cr.publish_status as file_state,
	           cr.item_id as item_id,
	           im_category_from_id(rev.doc_type) as document_type,
            ...
            from fs_objects, cr_items cr, cr_revisions rev
            where fs_objects.parent_id = :folder_id
            and cr.item_id=rev.item_id
