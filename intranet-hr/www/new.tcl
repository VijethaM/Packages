...
template::element::create $form_id availability -optional -label $availability_label -html {size 6} -widget "hidden"
...
template::element::create $form_id personnel_number -optional -label $personnel_number_label -html {size 10} -widget "hidden"
template::element::create $form_id ss_number -optional -label $ss_number_label -html {size 20} -widget "hidden"
template::element::create $form_id currency -label $currency_label -widget "hidden"  -options $currency_options -values $currency 
template::element::create $form_id hourly_cost -optional -label $hourly_cost_label -html {size 10} -datatype float -widget "hidden"
template::element::create $form_id salary -optional -label $salary_label -html {size 10} -datatype float -widget "hidden"
template::element::create $form_id social_security -optional -label $social_security_label -html {size 10} -datatype float -widget "hidden"
template::element::create $form_id insurance -optional -label $insurance_label -html {size 10} -datatype float -widget "hidden"
template::element::create $form_id other_costs -optional -label $other_cost_label -html {size 10} -datatype float -widget "hidden"
template::element::create $form_id salary_payments_per_year -optional -label $salary_payments_per_year_label -html {size 10} -widget "hidden"
...
template::element::create $form_id end_date -optional -label $end_date_label -html {size 10} -datatype date -widget "hidden"
template::element::create $form_id voluntary_termination_p -label $voluntary_termination_p_label -widget "hidden"  -options $voluntary_termination_options -datatype text
template::element::create $form_id termination_reason -optional -datatype text -widget textarea -label $termination_reason_label -html {rows 5 cols 40} -widget "hidden"
template::element::create $form_id signed_nda_p -optional -datatype text -widget radio -label $signed_nda_p_label -options {{Yes t} {No f}} -widget "hidden"
template::element::create $form_id vacation_days_per_year -optional -label $vacation_days_per_year_label -html {size 5} -datatype float -widget "hidden"
template::element::create $form_id vacation_balance -optional -label $vacation_balance_label -html {size 5} -datatype float -widget "hidden"
