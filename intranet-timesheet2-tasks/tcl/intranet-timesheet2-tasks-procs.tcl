...
#commented by vijetha@vmc no need to restrict for proken
...
#    }
	...
	where	view_id=:view_id
      ...
      and  column_name not in ('Material','Bll','UoM','Pln','\"%\"','\"CC\"','Plan','Bill','Done')
	order by sort_order
    "
    set col_span 0
...
set order_by_clause "child.project_id" 
    set sql "
	select
		t.*,
    ...
    if {!$write} { 
        set action_html "
           <tr>
				...
				<a href=\"[export_vars -base "/intranet-timesheet2-tasks/new" {{project_id $restrict_to_project_id} {return_url $current_url}}]\">[_ intranet-timesheet2-tasks.New_Timesheet_Task]</a>
                       </div>
			<!-- &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
			 <div style='float: left;'>
				<a href=\"[export_vars -base "/intranet-timesheet2-tasks/adhoc_new" {{project_id $restrict_to_project_id} {return_url $current_url}}]\">[_ intranet-timesheet2-tasks.New_Adhoc_Task]</a> 
                       </div>  -->
                </div>
                </td>
           </tr>
