...
<td colspan=7>
  ...
  <tr>
    ...
    <td align=center ><font color=#414042 ><a href=\"\">$month_heading</a></font></td>
...
ad_proc im_calendar_user_component { date user_id} {
    Returns a formatted HTML showing the status of notifications  for the current user
} {
    #  ns_log Notice "vijetha123456 ======= $user_id"
    # if  {![info exists $user_id] } {
    #      set user_id1 [ad_get_user_id]
    #       ns_log Notice "vijetha12345 ======= $user_id1"
    #  }
    # # set html "Notifications for You..................====$user_id"
    # ns_log Notice "vijetha123 ======= $user_id ==== $user_id1"
    # if {$user_id !=$user_id1} {
    #     set user_id 
    # }
