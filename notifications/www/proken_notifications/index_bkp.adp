<master >
<property name="title">The Work</property>

<TABLE border=\"5\" frame=\"border\" rules=\"all\" width='1000px;'>
	...
	<tr>
		<!-- My Tasks -->
			<td style="background: #dcf2f9;" width=800px;>        
				<ul class="tabs3">
				...
				<div class="tab_container">
					<div id="tab7" class="tab_content3" style="background: #f4f9fb;">
				       	<div id="visual_top_profit" style="width: 300px; height: 400px;">
				       		@out_table7;noquote@
				       	</div>
				       	<p align=right><a href="/intranet-reporting/project-profitability?flag2=1" target="_blank">View details</a></p>
				    </div>
				    <div id="tab8" class="tab_content3" style="background: #f4f9fb;">
				       <div id="visual_bottom_profit" style="width: 300px; height: 400px;">
				       	@out_table8;noquote@
				       </div>
				       <p align=right><a href="/intranet-reporting/project-profitability?flag2=1" target="_blank">View details</a></p>
				    </div>
				    <div id="tab9" class="tab_content3" style="background: #f4f9fb;">
					       <div id="visual_task9" style="width: 300px; height: 400px;">
					       	@out_table9;noquote@
					       </div>
					       <p align=right><a href="/intranet-reporting/project-profitability?flag2=1" target="_blank">View details</a></p>
					</div>
				    <div id="tab10" class="tab_content3" style="background: #f4f9fb;">
					       <div id="visual_task10" style="width: 300px; height: 400px;">
					       	@out_table10;noquote@
					       </div>
					      <p align=right><a href="/intranet-reporting/project-profitability?flag2=1&flag3=1" target="_blank">View details</a></p>
				    </div>
				</div>
			</td>
		<!-- </tr>
			...
			<td style="background: #dcf2f9;" width=800px;>        
				...
				<div class="tab_container">
					<div id="tab1" class="tab_content2" style="background: #f4f9fb;">
				       <div id="assigned_tasks_1" style="width: 300px; height: 400px;">
				       	@out_table1;noquote@
				       </div>
				       <p align=right><a href="/intranet-reporting/project-profitability?flag2=1" target="_blank">View details</a></p>
				    </div>
				    <div id="tab2" class="tab_content2" style="background: #f4f9fb;">
				       <div id="assigned_tasks_2" style="width: 300px; height: 400px;">
				       	@out_table2;noquote@
				       </div>
				       <p align=right><a href="/intranet-reporting/project-profitability?flag2=1" target="_blank">View details</a></p>
				    </div>
				    <div id="tab3" class="tab_content2" style="background: #f4f9fb;">
					       <div id="assigned_tasks_3" style="width: 300px; height: 400px;">
					       	@out_table3;noquote@
					       </div>
					       <p align=right><a href="/intranet-reporting/project-profitability?flag2=1" target="_blank">View details</a></p>
					</div>
				    <div id="tab4" class="tab_content2" style="background: #f4f9fb;">
					       <div id="assigned_tasks_4" style="width: 300px; height: 400px;">
					       	@out_table4;noquote@
					       </div>
					      <p align=right><a href="/intranet-reporting/project-profitability?flag2=1&flag3=1" target="_blank">View details</a></p>
				    </div>
